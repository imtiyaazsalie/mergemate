...
from mergemate.git_providers import get_git_provider, get_git_provider_with_context
...
async def _perform_auto_commands_github(
    commands_conf: str, agent: MergeMateAgent, body: dict, api_url: str, log_context: dict
):
    apply_repo_settings(api_url)
    if (
    ...
    for command in commands:
        ...
        await agent.handle(api_url, new_command)

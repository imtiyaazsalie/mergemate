...
# The server listens for incoming webhooks from Azure DevOps Server and forwards them to the MergeMate.
...
from mergemate.agent.mergemate import MergeMateAgent, command2class

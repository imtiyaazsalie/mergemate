...
async def handle_request(api_url: str, body: str, log_context: dict, sender_id: str, notify=None):
    ...
    with get_logger().contextualize(**log_context):
        await MergeMateAgent().handle_request(api_url, body, notify)

async def _perform_commands_gitlab(commands_conf: str, agent: MergeMateAgent, api_url: str,
...
def is_bot_user(data) -> bool:
    try:
        ...
        bot_indicators = ['mergemate', 'bot_', 'bot-', '_bot', '-bot']
    ...
    async def inner(data: dict):
        ...
        if data.get('object_kind') == 'merge_request':
            ...
            if object_attributes.get('action') in ['open', 'reopen']:
                ...
                await _perform_commands_gitlab("pr_commands", MergeMateAgent(), url, log_context, data)
            ...
            # for push event triggered merge requests
                ...
                await _perform_commands_gitlab("push_commands", MergeMateAgent(), url, log_context, data)

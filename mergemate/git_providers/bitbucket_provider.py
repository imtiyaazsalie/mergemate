...
class BitbucketProvider(GitProvider):
    ...
    # Example: git clone git clone https://bitbucket.org/mergemate/mergemate.git and branch: main -> prefix: "https://bitbucket.org/mergemate/mergemate/src/main", suffix: ""
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        if self.auth_type == "basic":
            ...
            get_logger().error(
                f"Unsupported or uninitialized auth_type: {getattr(self, 'auth_type', 'N/A')}. Returning None"
            )
            return None

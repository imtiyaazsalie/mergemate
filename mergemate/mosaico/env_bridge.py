"""Maps MOSAICO's env-var contract onto mergemate's Dynaconf settings and registers
...
# Token budget for a MOSAICO model not in mergemate's built-in MAX_TOKENS table.
...
def apply_mosaico_env() -> None:
    ...
    if model_name:
        ...
        # MOSAICO models are not in mergemate's built-in MAX_TOKENS table; declare a budget

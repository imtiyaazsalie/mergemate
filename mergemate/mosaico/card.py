"""Builds the MOSAICO A2A agent card for mergemate.
...
def _build_skills() -> list:
    return [
        AgentSkill(
            ...
            examples=["Review https://github.com/org/repo/pull/1", "Review this diff"],
        ),
        AgentSkill(
            id="improve",
            name="Improve",
            description="Propose concrete code suggestions to improve a pull request or " "supplied diff.",
            tags=["improve", "code-suggestions", "pull-request"],
            examples=["Improve https://github.com/org/repo/pull/1", "Suggest improvements for this diff"],
        ),
        AgentSkill(
            id="describe",
            name="Describe",
            ...
            examples=["Describe https://github.com/org/repo/pull/1", "Describe this diff"],
        ),
        AgentSkill(
            id="ask",
            name="Ask",
            ...
            examples=["What does this PR change?", "Ask https://github.com/org/repo/pull/1 what the risk is"],
        ),
    ]
...
def build_agent_card() -> AgentCard:
    ...
    return AgentCard(
        name=AGENT_NAME,
        description="MergeMate solution agent for pull-request and unified-diff code review. "

...
from mergemate.algo.ai_handlers.langchain_ai_handler import LangChainOpenAIHandler
...
async def measure_performance(handler, num_requests=3):
    ...
    tasks = [
        handler.chat_completion(
            model="gpt-3.5-turbo", system="You are a helpful assistant", user=f"Test message {i}", temperature=0.2
        )

...
from mergemate.agent.mergemate import MergeMateAgent, commands
from mergemate.cli import run
...
async def run_async() -> None:
    pr_url = os.getenv("TEST_PR_URL", "https://github.com/mergemate/mergemate/pull/1385")

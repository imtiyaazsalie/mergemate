...
from mergemate.mosaico.card import OBSERVABILITY_EXTENSION_URI, build_agent_card
...
class TestAgentCard:
    ...
    def test_observability_extension_uri_value(self):
        assert OBSERVABILITY_EXTENSION_URI == "https://mosaico-project.eu/extensions/mosaico-observability"
...
class TestRoutingDistinctiveness:
    ...
    @pytest.mark.skip(reason="settings-solution-agent.json registration file not present in repo")

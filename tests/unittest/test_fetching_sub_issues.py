...
# from mergemate.tools.ticket_pr_compliance_check import extract_tickets, extract_and_cache_pr_tickets
...
#         """
#         github_provider = GithubProvider()
#         issue_url = "https://github.com/the-settings/settings/issues/1499"  # Likely non-existent issue
#         result = github_provider.fetch_sub_issues(issue_url)
#

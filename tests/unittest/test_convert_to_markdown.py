...
from mergemate.algo.utils import PRReviewHeader, convert_to_markdown_v2
...
class TestConvertToMarkdown:
    ...
    def test_key_issues_to_review(self):
        ...
        reference_link = "https://github.com/mergemate/mergemate/pull/1/files#diff-hashvalue-R174"
    ...
    def test_can_be_split(self):
        input_data = {
            "review": {
                "can_be_split": [
                    {
                        "relevant_files": ["src/file1.py", "src/file2.py"],
                        "title": "Refactoring",
                    },
                    {
                        "relevant_files": ["src/file3.py"],
                        "title": "Bug Fix",
                    },
                ]
            }
...
class TestBR:
    def test_br1(self):
        ...
        expected_output = (
            "<ul><li>Imported <code>FilePatchInfo</code> and <code>EDIT_TYPE</code> from "
            "<code>mergemate.algo.types</code> instead <br>of "
            "<code>mergemate.git_providers.git_provider</code>.</ul>"
        )
    ...
    def test_br2(self):
        ...
        file_change_description_br = insert_br_after_x_chars(file_change_description)
        expected_output = (
            "<ul><li>Created a - new -class <code>ColorPaletteResourcesCollection </code><br><code>"
            "ColorPaletteResourcesCollection ColorPaletteResourcesCollection "

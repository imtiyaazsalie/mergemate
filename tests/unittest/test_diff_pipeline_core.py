...
Covers:
- mergemate.algo.git_patch_processing.decouple_and_convert_to_hunks_with_lines_numbers
- mergemate.algo.git_patch_processing.extract_hunk_lines_from_patch
- mergemate.algo.pr_processing.generate_full_patch
- mergemate.algo.pr_processing.pr_generate_compressed_diff
...
import mergemate.algo.pr_processing as pr_processing

"""
Security and behavior tests for mergemate.custom_merge_loader.
...
# Import mergemate.config_loader first (for its module-level side effects) to
# complete the config_loader import chain and avoid the circular import between
# mergemate.log and mergemate.custom_merge_loader.
importlib.import_module("mergemate.config_loader")
custom_merge_loader = importlib.import_module("mergemate.custom_merge_loader")

...
![Describe comment](https://mergemate.ai/images/mergemate/describe_comment.png){width=512}
...
By default, MergeMate tries to preserve your original PR description by placing it above the generated content.
This requires including your description during the initial PR creation.

"MergeMate removed the original description from the PR. Why"?
...
![Describe comment](https://mergemate.ai/images/mergemate/pr_description_user_description.png){width=512}
...
???+ example "Possible configurations"
    ...
    <table>
      ...
      <tr>
        ...
        <td>If set to true, it will add a comment message [`PR Description updated to latest commit...`](https://github.com/mergemate/mergemate/pull/499#issuecomment-1837412176) after finishing calling `/describe`. Default is true.</td>
      </tr>
      <tr>
...
The marker `mergemate:type` will be replaced with the PR type, `mergemate:summary` will be replaced with the PR summary, `mergemate:walkthrough` will be replaced with the PR walkthrough, and `mergemate:diagram` will be replaced with the sequence diagram (if enabled).

![Describe markers before](https://mergemate.ai/images/mergemate/describe_markers_before.png){width=512}

becomes

![Describe markers after](https://mergemate.ai/images/mergemate/describe_markers_after.png){width=512}
...
- `include_generated_by_header`: if set to true, the tool will add a dedicated header: 'Generated by MergeMate at ...' to any automatic content. Default is true.
...
![Add native custom labels](https://mergemate.ai/images/mergemate/add_native_custom_labels.png){width=768}

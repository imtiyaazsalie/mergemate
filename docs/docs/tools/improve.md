...
=== "Selecting a specific suggestion"
    ![code_suggestions_as_comment_open](https://mergemate.ai/images/mergemate/code_suggestions_as_comment_open.png){width=512}
...
![improve](https://mergemate.ai/images/mergemate/improve.png){width=512}
...
MergeMate supports two modes for presenting code suggestions: 

1) [Table](https://mergemate.ai/images/mergemate/code_suggestions_as_comment_closed.png) mode 

2) [Inline Committable](https://mergemate.ai/images/mergemate/improve.png) code comments mode.
...
Table mode is the default of MergeMate, and is recommended approach for most users due to these benefits. 

![code_suggestions_as_comment_closed.png](https://mergemate.ai/images/mergemate/code_suggestions_as_comment_closed.png){width=512}
...
MergeMate supports both simple and hierarchical best practices configurations to provide guidance to the AI model for generating relevant code suggestions.
...
![self_review_1](https://mergemate.ai/images/mergemate/self_review_1.png){width=512}
...
!!! tip "Tip - Demanding self-review from the PR author"
    ...
    ![self_review_2](https://mergemate.ai/images/mergemate/self_review_2.png){width=512}
...
MergeMate uses a dynamic strategy to generate code suggestions based on the size of the pull request (PR). Here's how it works:

#### 1. Chunking large PRs

- MergeMate divides large PRs into 'chunks'.
- Each chunk contains up to `config.max_model_tokens` tokens (default: 32,000).

#### 2. Generating suggestions

- For each chunk, MergeMate generates up to `pr_code_suggestions.num_code_suggestions_per_chunk` suggestions (default: 3).
...
Note: Chunking is primarily relevant for large PRs. For most PRs (up to 600 lines of code), MergeMate will be able to process the entire code in a single call.
